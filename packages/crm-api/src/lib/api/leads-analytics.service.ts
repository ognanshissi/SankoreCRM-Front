...
export class LeadsAnalyticsApiService {
     ...
     */
    public getAgentPerformance(from?: string, to?: string, agentId?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<AgentPerformanceDto>>;
    public getAgentPerformance(from?: string, to?: string, agentId?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<AgentPerformanceDto>>>;
    public getAgentPerformance(from?: string, to?: string, agentId?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<AgentPerformanceDto>>>;
    public getAgentPerformance(from?: string, to?: string, agentId?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
